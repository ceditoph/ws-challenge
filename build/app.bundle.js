  ...
  _createClass(Home, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        _react.Fragment,
        null,
        _react2.default.createElement(_lightbox2.default, { isHidden: this.state.thumbnails.length ? false : true, imageSet: this.state.thumbnails }),
        _react2.default.createElement(
          'div',
          { className: 'container' },
          this.state.groups.map(function (group, ind) {
            return _react2.default.createElement(
              'div',
              {
                key: group.id,
              ...
              _react2.default.createElement('img', {
                ...
                onClick: function onClick(e) {
                  return _this2.displayLightBox(e);
                }
              }),
              _react2.default.createElement(
                'div',
    ...
    key: 'displayLightBox',
    value: function displayLightBox(e) {
...
var Lightbox = function (_Component) {
  ...
  function Lightbox(props) {
    ...
    var _this = _possibleConstructorReturn(this, (Lightbox.__proto__ || Object.getPrototypeOf(Lightbox)).apply(this, arguments));
  ...
  _createClass(Lightbox, [{
    ...
    value: function componentWillReceiveProps(_ref) {
      ...
      this.setState({ isHidden: isHidden, imageSet: imageSet });
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      return this.state.isHidden ? null : _react2.default.createElement(
        'div',
        { id: 'lightbox', className: 'product-lightbox' },
        _react2.default.createElement(
          'div',
          ...
          _react2.default.createElement(
            'div',
            { className: 'close controls', onClick: this.hideLightbox.bind(this) },
            'x'
          ),
          _react2.default.createElement(
            'div',
            { className: 'prev controls', onClick: function onClick() {
                return _this2.selectPrevImage();
              } },
            '\u2329'
          ),
          _react2.default.createElement(
            'div',
            { className: 'next controls', onClick: function onClick() {
                return _this2.selectNextImage();
              } },
            '\u232A'
          ),
          _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            this.state.imageSet.map(function (image, ind) {
              return _react2.default.createElement('div', {
                key: image.rel + ind,
                id: ind,
                className: ind === Number(_this2.state.currentImageIndex) ? 'radio-filled' : 'radio-empty',
                type: 'radio',
                onClick: function onClick(e) {
                  return _this2.setActiveImage(e.target.id);
                }
              });
            })
          )
    ...
    key: 'setActiveImage',
    value: function setActiveImage(currentImageIndex) {
      this.setState({ currentImageIndex: currentImageIndex });
    }
  }, {
    key: 'selectPrevImage',
    value: function selectPrevImage() {
      var currentImage = document.getElementsByClassName('radio-filled')[0];

      var prevImageIndex = currentImage.id - 1 >= 0 ? currentImage.id - 1 : this.state.imageSet.length - 1;

      this.setActiveImage(prevImageIndex);
    }
  }, {
    key: 'selectNextImage',
    value: function selectNextImage() {
      var currentImage = document.getElementsByClassName('radio-filled')[0];

      var nextImageIndex = Number(currentImage.id) + 1 < this.state.imageSet.length ? Number(currentImage.id) + 1 : 0;
